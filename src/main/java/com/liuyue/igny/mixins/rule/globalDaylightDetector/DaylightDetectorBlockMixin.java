...
import net.minecraft.world.level.LightLayer; //?< 26.1
...
public class DaylightDetectorBlockMixin {
    ...
    private static int getBrightness(Level instance, LightLayer lightLayer, BlockPos pos, Operation<Integer> original) {
        ...
        if (IGNYSettings.GLOBAL_DAYLIGHT_DETECTOR.value() && !instance.dimensionType().hasSkyLight() && server != null) {
            ...
            return original.call(instance, lightLayer, new BlockPos(29999998, instance.getMaxBuildHeight(), 29999998)); //#replace >= 26.1 ? return original.call(instance, new BlockPos(29999998, instance.getMaxY(), 29999998));
        }
        return original.call(instance, lightLayer, pos); //#replace >= 26.1 ? return original.call(instance, pos);
    }
    ...
    private static float getSunAngle(Level instance, float f, Operation<Float> original) {
        ...
        return original.call(instance, f); //#replace >= 1.21.11 ? return original.call(system, environmentAttribute, pos);
    }
}
