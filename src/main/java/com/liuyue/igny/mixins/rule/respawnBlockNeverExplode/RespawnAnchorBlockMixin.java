...
public class RespawnAnchorBlockMixin {
    ...
    //#endif
    private void explode(RespawnAnchorBlock instance, BlockState state, Level level, BlockPos pos2, Operation<Void> original) //#replace >= 1.21.11 ? private void explode(RespawnAnchorBlock instance, BlockState state, ServerLevel level, BlockPos pos2, Operation<Void> original)
    {
