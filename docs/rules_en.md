...
`false`: Follows vanilla behavior.  
`ops`: Only operators (OPs) can use Game Master blocks in any game mode.  
`true`: Anyone can use Game Master blocks in any game mode.
...
## enderDragonRemoveSkipReintroduce `MC>=26.1`
